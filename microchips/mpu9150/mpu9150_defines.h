/*! \file mpu9150_defines.h
 *  \brief includes all register address of sensor and bit defines for settings
 *  \author Lukas Kiechle
 *  \date 2015-12-01 creat date
 *  \copyright
 *	\version 0.1
 *	\todo - check if all register address right and defined
 */

#ifndef PROJECT_HAL_MPU_H_
#define PROJECT_HAL_MPU_H_
